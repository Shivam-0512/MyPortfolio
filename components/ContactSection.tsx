    ...
    <section id="contact" className="py-24 px-6 md:px-12 lg:px-24 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <PixelContainer>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span
                  ...
                  style={{ fontSize: '0.5rem', color: '#facc15', letterSpacing: '0.08em' }}
                >
                  NEW QUEST AVAILABLE!
                </span>
              </div>
              ...
              <div className="space-y-2 mb-5" style={{ borderLeft: '2px solid #4338ca', paddingLeft: 12 }}>
                {[
                  ...
                  <div key={r.label} className="flex gap-2">
                    <span className="font-pixel flex-shrink-0" style={{ fontSize: '0.35rem', color: '#6366f1', minWidth: 80 }}>
                      {r.label}
                    </span>
                    <span className="font-pixel" style={{ fontSize: '0.35rem', color: '#94a3b8' }}>:</span>
                    <span className="font-pixel" style={{ fontSize: '0.35rem', color: '#e2e8f0' }}>{r.val}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={c.label} className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-pixel" style={{ fontSize: '0.32rem', color: '#6366f1' }}>{c.label}</div>
                      {c.href ? (
                        <a
                          href={c.href}
                          className="font-pixel transition-colors"
                          style={{ fontSize: '0.36rem', color: '#94a3b8', textDecoration: 'none' }}
                        ...
                        <span className="font-pixel" style={{ fontSize: '0.36rem', color: '#94a3b8' }}>{c.val}</span>
                      )}
                    </div>
                  </div>
                ))}
          ...
          >
            <PixelContainer title="// QUEST FORM — SEND MESSAGE">
              {status === 'success' ? (
                <div className="flex flex-col items-center justify-center gap-4 py-12 text-center">
                  <CheckCircle size={40} color="#4ade80" />
                  <div className="font-pixel" style={{ fontSize: '0.55rem', color: '#4ade80' }}>
                    QUEST COMPLETE!
                  </div>
                  <div className="font-pixel" style={{ fontSize: '0.36rem', color: '#475569' }}>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  {status === 'error' && (
                    <p className="font-pixel" style={{ fontSize: '0.38rem', color: '#f87171' }}>
